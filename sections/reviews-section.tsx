  ...
  return (
    <section id="reviews" className="bg-[#09060b] py-20">
      <div className="mx-auto w-full max-w-7xl px-4 md:px-6">
        <div className="motion-fade-up mb-8 flex flex-wrap items-end justify-between gap-4">
          <div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {testimonials.map((item, index) => (
            <article
              key={item.quote}
              className="motion-fade-up hover-lift flex h-full flex-col rounded-2xl border border-gold/20 bg-[linear-gradient(160deg,rgba(22,14,20,0.88),rgba(9,6,10,0.84))] p-6"
