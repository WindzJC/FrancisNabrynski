  ...
  return (
    <section id="contact" className="bg-ink py-20">
      <div className="mx-auto w-full max-w-7xl px-4 md:px-6">
        <div className="motion-fade-up grid gap-8 rounded-[2rem] border border-gold/20 bg-[linear-gradient(165deg,rgba(22,14,20,0.9),rgba(10,7,11,0.88))] p-7 shadow-luxe md:p-10 lg:grid-cols-[0.85fr,1.15fr]">
          ...
          <form className="motion-fade-up motion-delay-2 grid gap-4" action="#" method="post">
            ...
            <button
              type="submit"
              className="hover-lift inline-flex w-fit rounded-lg bg-[linear-gradient(135deg,#7a2f3e,#b8707f)] px-6 py-3 font-semibold text-white shadow-[0_12px_30px_rgba(143,49,71,0.4)] transition hover:-translate-y-0.5"
            >
              Send Message
            </button>
          </form>
